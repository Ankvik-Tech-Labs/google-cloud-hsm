...
def convert_der_to_rsv(signature: bytes, v_adjustment_factor: int = 0) -> dict:
    ...
    Returns:
        dict: A dictionary containing the r, s, and v components
    """
...
def verify_signed_transaction(w3: Web3, signed_tx: TransactionAPI, signer_address: str) -> tuple[bool, dict[str, Any]]:
    """
